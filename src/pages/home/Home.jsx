        ...
        <div className='home'>
            ...
            <div className="features">
                <div className="container">
                    ...
                    <div className="item">
                        <video src="https://fiverr-res.cloudinary.com/q_auto,f_auto,w_700,dpr_1.0/v1/attachments/generic_asset/asset/089e3bb9352f90802ad07ad9f6a4a450-1599517407052/selling-proposition-still-1400-x1.png" controls></video>
                    </div>
                </div>
            </div>
            ...
            <SlideProject slidesToShow={4} arrowsScroll={4}>
                {
                    projects.map((card) => (
